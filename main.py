...
\\- Рецепты из холодильника \\- отправьте фото, получите рецепты
\\- Определить блюдо \\- отправьте фото, узнайте что это и как приготовить

📝 *Индивидуальные предпочтения:*
\\- Расскажите о своих вкусах \\- получите персонализированные рекомендации

📚 *Работа с рецептами:*
\\- Добавить рецепт \\- пошаговое добавление нового рецепта
\\- Рецепты \\- просмотр всех ваших рецептов
\\- Случайный рецепт \\- случайный выбор из вашей коллекции
\\- Найти рецепт \\- поиск по ингредиентам

🤖 *Интеллектуальные функции:*
\\- Giga \\- диалог с кулинарным помощником
\\- Сгенерировать фото \\- создание изображения блюда через ИИ

⚙️ *Настройки:*
\\- Конфиденциальность \\- управление видимостью ваших рецептов
\\- Помощь \\- показать это сообщение

💡 *Прочее:*
\\- Отправьте текст: GigaChat ответит на ваш кулинарный вопрос
\\- Отправьте голосовое сообщение: оно будет расшифровано и отправлено GigaChat
'''
router_main = Router()
